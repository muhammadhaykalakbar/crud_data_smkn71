...
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <li><a href="tmapel.php">Mapel</a></li>
 ...
 <br>
    ...
    <a href="tambah.php" class="icon-button">
        <i class="fas fa-plus" herf="tambah.php"> TAMBAH MAPEL</i>
    </a>
    <br/>
    <br/>
    <table class="table1">
    ...
    <?php
        ...
        $data = mysqli_query($koneksi,"select * from mapel limit $halaman_awal, $batas");
    ...
    ?>
            <tr>
                ...
                <td><?php echo $d['jumlah_jp']; ?></td>
                <td><?php echo $d['guru']; ?></td>
                <td>
                    <a href="edit.php?id_mapel=<?php echo $d['id_mapel']; ?>"onclick="return confirm ('Yakin mau diedit?');" class="btn btn-outline-success">
                    <i class="fas fa-pen"></i> </a></td>
                    <td><a href="hapus.php?id_mapel=<?php echo $d['id_mapel']; ?>"onclick="return confirm ('Yakin mau dihapus?');" class="btn btn-outline-danger">
